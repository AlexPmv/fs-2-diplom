  ...
  <main>
    <section class="register">
      ...
      <div class="register__wrapper">
        <form class="register__form" form method="POST" action="{{ route('register') }}">
            @csrf
            ...
            <label class="register__label" for="mail">
                {{ __('E-mail') }}
                <input id="email" type="email" class="register__input" name="email" value="{{ old('email') }}" placeholder="example@domain.xyz" required autocomplete="email">
                @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <label class="register__label" for="password-confirm">
            ...
            <input value="Зарегистрироваться" type="submit" class="register__button">
            </div>
        </form>
      </div>
    </section>
